...
const WHATSAPP_GROUP = 'https://chat.whatsapp.com/Jk8TEuezlcC7D8jUHaHHJe?mode=gi_t'

export default function WhatsAppFloat() {
  const { settings } = useSettings()
  const number = settings.whatsappNumber || '919250324379'

  const handleClick = () => window.open(WHATSAPP_GROUP, '_blank', 'noopener,noreferrer')
  ...
  return (
    <div className="whatsapp-float-wrapper" aria-label="Join our WhatsApp group">
      ...
      <button onClick={handleClick} className="whatsapp-fab" aria-label="Open WhatsApp">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" fill="white" width="18" height="18" aria-hidden="true">
